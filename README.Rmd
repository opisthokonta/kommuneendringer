...
It currently only supports translating municipality codes. I will soon add functionality for translating county codes as well. 
...
A simple example is the municipality Halden. It hasn't merged with any other municipality recently, but changed county, and therefore its code, in 2020 (from Østfold to Viken) and back to Østfold again in 2024, when Viken was split, getting yet a new code.
